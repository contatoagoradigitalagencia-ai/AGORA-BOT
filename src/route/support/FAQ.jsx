		...
		<div className="flex flex-col bg-zinc-900 border border-zinc-800 rounded-xl p-5 h-[500px]">
			...
			<div className="flex flex-col gap-3 overflow-y-auto pr-1">
				...
				<div className="bg-zinc-800 border border-zinc-700 rounded-lg p-4">
					<div className="flex items-center gap-2 mb-2">
						<i className="bi bi-question-circle text-orange-500" />
						<h3 className="font-medium">O bot não responde com produtos do catalogo?</h3>
					</div>
					<p className="text-sm text-zinc-400">Na aba "<Link className="underline" to="/spreadsheets" target="_blank">Catalogo</Link>" verifique se existem produtos, servicos ou planos cadastrados no MongoDB.</p>
				</div>
				<div className="bg-zinc-800 border border-zinc-700 rounded-lg p-4">
					<div className="flex items-center gap-2 mb-2">
						<i className="bi bi-question-circle text-orange-500" />
